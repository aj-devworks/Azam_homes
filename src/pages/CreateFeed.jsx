    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      >
        <div className="bg-white rounded-2xl shadow-lg p-5 space-y-4">
          <div className="border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center py-8 text-gray-400 cursor-pointer hover:border-sky-400 hover:text-sky-500 hover:bg-sky-50/50 transition">
            <Upload size={24} />
            <p className="text-sm mt-2">Tap to upload photos</p>
          </div>
